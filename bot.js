...
function createBot() {
    const bot = mineflayer.createBot({
        host: 'DIOSESMC8.aternos.me', // <--- REEMPLAZA ESTO POR LA IP DE TU SERVER
        port: 40388,                // Puerto predeterminado de Minecraft
        username: 'snow_cruston',    // Nombre genérico del bot/NPC dentro del juego
